...
Private Sub removeAllClassExt()
    ...
    'if the workspace is SDE geodatabase or File/Personal geodatabase then execute the code
    If (pGxApp.SelectedObject.Category = "Database Connection" Or pGxApp.SelectedObject.Category = "File Geodatabase" Or pGxApp.SelectedObject.Category = "Personal Geodatabase") Then
